...
from . views import (get_posts, like_post, comments_count, get_likes, bookmark_post, 
                     ...
                     search_hashtags, get_posts_by_hashtag, get_hashtag_detail, search_content, like_comment)
...
urlpatterns = [
    ...
    path('posts/<int:post_id>/comments/<int:comment_id>/like/', views.like_comment, name='like_comment'),
