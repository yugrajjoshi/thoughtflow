...
export default function ProfileView() {
    ...
    const loadUserPosts = useCallback(async (targetUsername) => {
        ...
        try {
            ...
            const onlyUserPosts = allPosts.filter((post) => post.username === targetUsername);
            ...
            <div className="ml-[20%] flex h-screen w-[80%] bg-black">
                <section className="w-2/3 h-screen overflow-y-auto overscroll-none posts-scrollbar">
                    ...
                    <section className="flex flex-col w-full">
                        <section className="flex w-full h-56 md:h-72 border-zinc-500 text-white items-center justify-center">
                            {bannerPicture ? (
                    ...
                    <section className="w-full">
                        <div className=" flex px-5 py-4 border-b justify-between items-center border-zinc-800">
